...
<head>
    ...
    <title>Categorias - Inventa</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            $resultadoEditar = $conexion->query("SELECT * FROM categorias WHERE id_categorias  = $id_categoria");
                                        ...
                                        <tbody>
                                            <?php while ($fila = $resultado->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!--Boton para editar-->
                                                        <a href="categorias.php?id=<?php echo $fila['id_categorias']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="fas fa-pen-to-square"></i>
                                                        </a>
                                                        <!-- Botón para eliminar -->
                                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar" onclick="setEliminarId(<?php echo $fila['id_categorias']; ?>)">
