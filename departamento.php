...
include 'controladores/procesar_departamento.php';
...
<head>
    ...
    <title>Departamento - Inventa</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            $resultadoEditar = $conexion->query("SELECT * FROM departamento WHERE id_departamento = $id_departamento");
                            if ($filaEditar = $resultadoEditar->fetch_assoc()) {
                                $nombreDepartamento = $filaEditar['nombre'];
                            } else {
                        ...
                        <div class="card mb-2">
                            <div class="card-header">
                                <h5 class="card-title mb-0"><?php echo isset($_GET['id']) ? 'Editar Departamento' : 'Registrar Nuevo Departamento'; ?></h5>
                            </div>
                            <div class="card-body">
                                <form method="POST">
                                    <div class="mb-3">
                                        <label for="nombre" class="form-label">Nombre del departamento</label>
                                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo htmlspecialchars($nombreDepartamento); ?>" required>
                                    </div>
                                    <?php if (isset($_GET['id'])): ?>
                                        <input type="hidden" name="id_departamento" value="<?php echo intval($_GET['id']); ?>">
                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Departamentos registrados: <?php echo $totalDepartamento; ?></h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php while ($fila = $resultado->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!--Boton para editar-->
                                                        <a href="departamento.php?id=<?php echo $fila['id_departamento']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="fas fa-pen-to-square"></i>
                                                        </a>
                                                        <!-- Botón para eliminar -->
                                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar" onclick="setEliminarId(<?php echo $fila['id_departamento']; ?>)">
