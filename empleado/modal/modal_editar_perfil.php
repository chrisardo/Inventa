                    ...
                    <div class="row g-2 mb-3">
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nombreEmpresa" name="nombre" value="<?= htmlspecialchars($usuario['nombre']) ?>" required>
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-success text-white"><i class="bi bi-person"></i></span>
                                <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Apellidos" value="<?= htmlspecialchars($usuario['apellido']) ?>" required>
                            </div>
                        </div>
                    </div>
