                        ...
                        <div class="card p-2">
                            <form id="formBuscar" class="d-flex" method="GET" action="lista_clientes.php">
                                <input
                                    ...
                                    type="search"
                                    name="buscar"
                                    placeholder="Buscar cliente por nombre, documento, celular"
                        ...
                        <div class="card p-2">
                            <div class="btn-group">
                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
                                    <i class="bi bi-file-earmark-arrow-down"></i>Exportar clientes
                                </button>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="controladores/exportar_clientes_pdf.php" target="_blank">
                                            <i class="fas fa-file-pdf"></i> Exportar como PDF
                                        </a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <a href="controladores/exportar_clientes_excel.php" class="dropdown-item" target="_blank">
                                        ...
                                        <?php while ($fila = $resultado->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- Botón para eliminar -->
                                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar" onclick="setEliminarId(<?php echo $fila['idCliente']; ?>)">
