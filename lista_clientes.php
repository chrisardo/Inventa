                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <?php if ($totalClientes > 0): ?>
                                            <a class="dropdown-item" href="controladores/exportar_clientes_pdf.php" target="_blank">
                                    ...
                                    <li>
                                        <?php if ($totalClientes > 0): ?>
                                            <a class="dropdown-item" href="controladores/exportar_clientes_excel.php" target="_blank">
