...
<head>
    ...
    <title>Proveedores - Inventa</title>
...
<body>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled ps-4" id="menuProveedores">
                        ...
                        <li>
                            <a class="nav-link text-info" href="lista_proveedores.php">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Lista de proveedores: <?php echo $totalProveedores; ?></h5>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button
                                                        ...
                                                        data-id="<?php echo $fila['id_provedor']; ?>"
                                                    ...
                                                    <!-- Botón para eliminar -->
                                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar" onclick="setEliminarId(<?php echo $fila['id_provedor']; ?>)">
    ...
    <?php include 'modal/modal_proveedores.php'; ?>
    <script src="js/lista_proveedores.js"></script>
