...
include 'controladores/procesar_marcas.php';
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled ps-4" id="menuInventario">
                        ...
                        <li>
                            <a class="nav-link text-info" href="marca.php">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            $resultadoEditar = $conexion->query("SELECT * FROM marcas WHERE id_marca  = $id_marca");
                            if ($filaEditar = $resultadoEditar->fetch_assoc()) {
                                $nombreMarca = $filaEditar['nombre'];
                            } else {
                                echo "<div class='alert alert-danger'>Marca no encontrado.</div>";
                                $nombreMarca = "";
                            }
                        } else {
                            $nombreMarca = "";
                        ...
                        <div class="card mb-2">
                            <div class="card-header">
                                <h5 class="card-title mb-0"><?php echo isset($_GET['id']) ? 'Editar Marca' : 'Registrar Nueva Marca'; ?></h5>
                            </div>
                            <div class="card-body">
                                <form method="POST">
                                    <div class="mb-3">
                                        <label for="nombre" class="form-label">Nombre</label>
                                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo htmlspecialchars($nombreMarca); ?>" required>
                                    </div>
                                    <?php if (isset($_GET['id'])): ?>
                                        <input type="hidden" name="id_marca" value="<?php echo intval($_GET['id']); ?>">
                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Marcas registradas: <?php echo $totalMarcas; ?></h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php while ($fila = $resultado->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!--Boton para editar-->
                                                        <a href="marca.php?id=<?php echo $fila['id_marca']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="fas fa-pen-to-square"></i>
                                                        </a>
                                                        <!-- Botón para eliminar -->
                                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar" onclick="setEliminarId(<?php echo $fila['id_marca']; ?>)">
