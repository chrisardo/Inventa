...
include 'controladores/procesar_registro_proveedor.php';
...
<head>
    ...
    <title>Registro proveedor - Inventa</title>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled ps-4" id="menuProveedores">
                        <li>
                            <a class="nav-link text-info" href="registrar_proveedor.php">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-2 mb-3">
                                <div class="col">
                                    <label for="imagen" class="form-label">Nombre:</label>
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-success text-white"><i class="bi bi-person"></i></span>
                                        <input type="number" min="0" class="form-control" id="ruc" name="ruc" placeholder="Ruc o DNI" required>
                                    </div>
                                </div>
                            </div>
                            <!--Direccion + Telefono -->
