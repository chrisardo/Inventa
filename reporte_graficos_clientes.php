...
<head>
    ...
    <title>Reporte cliente — Inventa</title>
...
<body>
    <div class="d-flex vh-100 overflow-hidden">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled ps-4" id="menuReportes">
                        <li>
                            <a class="nav-link text-info" href="reporte_graficos_clientes.php">
        ...
        <div id="content">
            ...
            <div class="container-fluid p-4">
                <!-- Título -->
                <h2 class="mb-4">Reporte gráficos de los clientes</h2>
                <form method="GET" id="formFiltros">
                    <div class="row g-4">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="card border-success mb-3">
                                <div class="card-header text-white bg-success text-center">Filtrar cliente:</div>
                                <div class="card-body">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="card border-success mb-3">
                                <div class="card-header text-white bg-success text-center">Filtrar Rubro:</div>
                                <div class="card-body">
                                    <select name="rubro" id="rubro" class="form-select">
                                        <option value="">-- Todos los rubros --</option>
                                        <?php
                                        $sql = "SELECT id_rubro, nombre,id_user FROM rubros where id_user = " . $_SESSION['usId'] . " ORDER BY nombre ASC";
                                        $res = mysqli_query($conexion, $sql);
                                        while ($row = mysqli_fetch_assoc($res)) {
                                            echo "<option value='{$row['id_rubro']}'>{$row['nombre']}</option>";
                                        }
                                        ?>
                                    </select>
                ...
                <div class="container my-0 py-2">
                    ...
                    <div class="row row-cols-1 row-cols-md-0">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <div class="card mb-3">
                                <div class="card-header bg-success text-white text-center">Clientes registrados por dia</div>
                                <div class="grafico-container"><canvas id="clienteDia"></canvas></div>
                            </div>
                        </div>
                    </div>
                    <div class="row row-cols-1 row-cols-md-0">
                        <div class="col-sm-6">
                            <div class="card mb-3">
                                <div class="card-header bg-success text-white text-center">Monto total de los clientes que compran por Mes</div>
                    ...
                    <div class="row row-cols-1 row-cols-md-0">
                        <div class="col-sm-6">
                            <div class="card mb-3">
                                <div class="card-header bg-success text-white text-center">Clientes registrados por rubro</div>

                                <div class="grafico-container"><canvas id="clientesPorRubro"></canvas></div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="js/dashboards_clientes.js"></script>
