...
include 'controladores/procesar_rubro.php';
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled ps-4" id="menuClientes">
                        ...
                        <li>
                            <a class="nav-link text-info" href="rubro.php">
            ...
            <div class="container-fluid p-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                        if (isset($_GET['id'])) {
                            $id_rubro = intval($_GET['id']);
                            $resultadoEditar = $conexion->query("SELECT * FROM rubros WHERE id_rubro = $id_rubro");
                            if ($filaEditar = $resultadoEditar->fetch_assoc()) {
                                $nombreRubro = $filaEditar['nombre'];
                            } else {
                        ...
                        <div class="card mb-2">
                            <div class="card-header">
                                <h5 class="card-title mb-0"><?php echo isset($_GET['id']) ? 'Editar Rubro' : 'Registrar Nuevo Rubro'; ?></h5>
                            </div>
                            <div class="card-body">
                                <form method="POST">
                                    <div class="mb-3">
                                        <label for="nombre" class="form-label">Nombre del rubro</label>
                                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo htmlspecialchars($nombreRubro); ?>" required>
                                    </div>
                                    <?php if (isset($_GET['id'])): ?>
                                        <input type="hidden" name="id_rubro" value="<?php echo intval($_GET['id']); ?>">
                                        ...
                                        <a href="rubro.php" class="btn btn-secondary">Cancelar</a>
                                    <?php else: ?>
                                        <button type="submit" name="accion" value="registrar" class="btn btn-success">Registrar Rubro</button>
                                    <?php endif; ?>
                                </form>
                            </div>
                        </div>
                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Lista de rubros: <?php echo $totalRubros; ?></h5>
                                </div>
                                <div class="card-body">
                                            ...
                                            <?php while ($fila = $resultado->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="rubro.php?id=<?php echo $fila['id_rubro']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="fas fa-pen-to-square"></i>
                                                        </a>
                                                        <!-- Botón para eliminar rubro -->
                                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar" onclick="setEliminarId(<?php echo $fila['id_rubro']; ?>)">
